...
public partial class RouterRpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select  *  from troubleview order by transid", sqlCon);
            da.Fill(dt);
            //ds.Tables(0).Merge(dt);
            rptDoc.Load(Server.MapPath("crpRouter.rpt"));
