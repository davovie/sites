<%@ Page Language="C#" MasterPageFile="~/LongMaster.master" AutoEventWireup="true" CodeFile="MsTrouble2 - Copy (2).aspx.cs" EnableEventValidation="false" Inherits="MsRouter" Title="Trouble Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
           ...
           <label>NUMBER</label>
                            <asp:TextBox ID="txtTransID" class="form-control" placeholder="Enter Router No" Width="66%" runat="server"></asp:TextBox>
        ...
        <hr />
                        ...
                        <div class="form-group">
                             <div class="form-inline">
                           <label>To</label>
                            <asp:DropDownList ID="ddlApproval" Width="15%" class="form-control" runat="server" OnSelectedIndexChanged="ddlDept_SelectedIndexChanged1"></asp:DropDownList>
                            <label>Dept</label>
                             <asp:DropDownList ID="ddlDept" Width="18%" class="form-control" runat="server" OnSelectedIndexChanged="ddlDept_SelectedIndexChanged1"></asp:DropDownList>
                                 
                            <label>Location</label>
                            <asp:TextBox ID="txtLocate1" Width="52%" class="form-control" placeholder="Enter Location" runat="server"></asp:TextBox>
                            <hr />
                                 <label>Date</label>
                           ...
                           <label>Station</label>
                            ...
                            <asp:TextBox ID="txtApparatus" class="form-control" placeholder="Enter Apparatus" Width="99%" runat="server"></asp:TextBox>
                                     
                <hr />
                             <div class="form-inline">
                            <label>Fault Code</label>
                            <asp:TextBox ID="txtFaultCode" class="form-control" placeholder="Enter Code" Width="10%" runat="server"></asp:TextBox>
           ...
           <asp:TextBox ID="txtPrepareby" class="form-control" Width="56%" placeholder="Enter Name" runat="server"></asp:TextBox>             
       </div>
             </div>
             </div>
                </div>   
            ...
            <h3 class="panel-title">REPAIR REPORT</h3>
             ...
             <div class="col-md-3">
              ...
              <div class="col-md-9">
               <div class="form-group">
                        <div class="form-inline">
                            <label>MAINTENACE FOREMAN</label>
                            <asp:TextBox ID="txtCertify" class="form-control" placeholder="Enter Name" Width="38%" runat="server"></asp:TextBox>
                            <label>Date</label>
