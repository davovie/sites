<%@ Page Language="C#" MasterPageFile="~/Admin/ALongMaster.master" AutoEventWireup="true" CodeFile="MsTrouble.aspx.cs" EnableEventValidation="false" Inherits="MsTrouble" Title="Trouble Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">Trouble Transaction</h3>
        </div>
        <div class="panel-body">
            ...
            <hr />
                             ...
                             <%--<asp:DropDownList ID="ddlDes" Width="100%" class="form-control" runat="server"  
                    AutoPostBack="True"  
                    onselectedindexchanged="ddlDept_SelectedIndexChanged" >
                </asp:DropDownList>--%>
