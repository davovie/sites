...
public partial class MsRouter : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
       ...
       //string invdate = txtTransDate.Text.ToString();
       // string locate = txtLocate.Text;
       ////DateTime invdate = DateTime.Parse(Request.Form[txtDate.UniqueID]);
       // string faultcode = txtFaultCode.Text.ToString();
       // string des = txtDes.Text.ToString();
       // string locate1 = txtLocate1.Text.ToString();
       // string reason = txtReason.Text.ToString();
       // string workdn = txtWorkdn.Text.ToString();
       // string certify = txtCertify.Text.ToString();
       // string certdate = txtCertDate.Text.ToString();
